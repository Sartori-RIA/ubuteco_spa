...
export class WineStylesEffects {
  ...
  fetchAllWines$ = createEffect(() => this.actions$.pipe(
    ...
    mergeMap(() => this.wineStyleService.all()).pipe(
  ...
  newWineStyle$ = createEffect(() => this.actions$.pipe(
    ...
    mergeMap((action) => this.wineStyleService.create(action.style)).pipe(
      map((style) => {
  ...
  deleteWineStyle$ = createEffect(() => this.actions$.pipe(
    ...
    mergeMap((action) => this.wineStyleService.destroy(action.id)).pipe(
      map((res) => {
  ...
  updateWineStyle$ = createEffect(() => this.actions$.pipe(
    ...
    mergeMap((action) => this.wineStyleService.update(action.style)).pipe(
      map((beerStyle) => {
